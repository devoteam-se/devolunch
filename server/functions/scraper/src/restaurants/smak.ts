...
export const browserScrapeFunction = (page: Page) =>
  page.evaluate(() => {
    ...
    const lunchArray = (document.querySelector('div.lunch-container') as HTMLElement)?.innerText
      ?.split('\n')
    ...
    const veg = lunchArray[fishIndex !== -1 ? 3 - fishIndex : todayIndex + 2];
